      ...
      <div class="old-info">
        ...
        <div class="old-info__text">
          <el-row :gutter="30">
            <el-col :xs="24" :sm="10">
              <div class="old-info__name">
                {{ $t("contract.procuring_info_value") }} ({{ procurementInfo.currency }})
              </div>
            </el-col>
            <el-col :xs="24" :sm="14">
      ...
      <div class="old-info" v-if="documents.length">
        ...
        <div class="old-info__text" v-for="(document, key) of documents" :key="document.id + key">
          <el-row :gutter="30">
            ...
            <el-col :xs="24" :sm="14">
              <div class="old-info-document_date-published">
                {{ $t("contract.documents_published") }} {{ document.datePublished }}
              </div>
          ...
          >
            ...
            <el-col :xs="24" :sm="14">
              <div class="old-info-document_date-published">
                {{ $t("contract.documents_published") }} {{ oldDoc.datePublished }}
              </div>
        ...
        <template v-for="item in items">
          ...
          <div class="old-info__text" :key="item.id + 1">
            <el-row :gutter="30">
              <el-col :xs="24" :sm="10" />
              <el-col :xs="24" :sm="14">
                <div class="old-info__value info__value_muted">{{ $t("contract.items_cpv") }}: {{ item.cpv }}</div>
