      ...
      <div>
        <div class="info-blocks">
          ...
          <div v-if="auction.auctionProgress && auction.auctionProgress.length">
            ...
            <el-row :gutter="15">
              <el-col :sm="12">
                <div class="info-block__text">{{$t("tender.minimal_eligible_difference")}}:
                </div>
              </el-col>
              <el-col :sm="12">
                <div class="info-block__text">
          ...
          <div v-else>
            <el-row :gutter="15">
              <el-col :sm="12">
                <div class="info-block__text">{{$t("tender.start_date")}}:
                </div>
              </el-col>
              <el-col :sm="12">
                <div class="info-block__text">
        ...
        <div v-if="auction.auctionProgress && auction.auctionProgress.length">
          ...
          <div class="info-blocks info-blocks_auction"
          ...
          >
            ...
            <div v-for="breakdown of progress.breakdowns"
                 class="info-block"
            >
              <el-row :gutter="15">
                <el-col :sm="12">
        ...
        <div v-if="auction.results && auction.results.length">
          ...
          <div class="info-blocks"
               v-for="result of auction.results"
          >
            <el-row :gutter="15">
              <el-col :sm="12">
                <div class="info-block__value">
              ...
              <el-col :sm="12">
                <div class="info-block__value">{{fa(result.value.amount)}}
                </div>
                <div class="info-block__text">
