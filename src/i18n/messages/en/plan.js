export default {
  ...
  big_guarantee_must_be_valid:
    " The amount and currency of the big guarantee that must be valid 90 days starting from opening of the tenders",
  ...
  complementary_information_list2_p4_2:
    "of estimated value MDL and must be valid 90 days starting from opening of the tenders.",
